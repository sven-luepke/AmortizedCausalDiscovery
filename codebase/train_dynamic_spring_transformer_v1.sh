...
python -m train --suffix _springs5_dynamic1 --dynamic 1 --epochs=500 --encoder=transformer_old
python -m train --suffix _springs5_dynamic2 --dynamic 2 --epochs=500 --encoder=transformer_old
python -m train --suffix _springs5_dynamic3 --dynamic 3 --epochs=500 --encoder=transformer_old